...
- Translation support with POT file in `languages/` directory
- Translator comments for strings with placeholders
- Keywords to `composer.json` and `package.json` for better discoverability
- Translation instructions in README.md
